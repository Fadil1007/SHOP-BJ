...
class getEmailServiceService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/src/Service/EmailService.php';
        ...
        return $container->privates['App\\Service\\EmailService'] = new \App\Service\EmailService(new \Symfony\Component\Mailer\Mailer($a, $b, $c), $d, ($container->services['router'] ?? self::getRouterService($container)));
    }
}
