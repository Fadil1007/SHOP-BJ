...
class getPaginationRuntimeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/knplabs/knp-paginator-bundle/src/Twig/Extension/PaginationRuntime.php';
        include_once \dirname(__DIR__, 5).'/vendor/knplabs/knp-paginator-bundle/src/Helper/Processor.php';
