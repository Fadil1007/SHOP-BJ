...
class getPrestaSitemap_DumperService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/presta/sitemap-bundle/src/Service/DumperInterface.php';
        include_once \dirname(__DIR__, 5).'/vendor/presta/sitemap-bundle/src/Service/Dumper.php';
