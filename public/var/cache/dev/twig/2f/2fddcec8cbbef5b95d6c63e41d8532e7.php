...
class __TwigTemplate_c38a2827cd137537bb47ecac5643f771 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/config/index.html.twig"));
...
";
    ...
    <div class=\"row\">
                    ...
                    <div class=\"mb-4\">
                        ...
                        <div class=\"d-flex align-items-center\">
                            <div class=\"me-3\">
                                <span class=\"badge bg-";
        // line 78
        yield (((($tmp = (isset($context["maintenance_mode"]) || array_key_exists("maintenance_mode", $context) ? $context["maintenance_mode"] : (function () { throw new RuntimeError('Variable "maintenance_mode" does not exist.', 78, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("success") : ("secondary"));
        yield " p-2\">
                                    ";
        // line 79
        yield (((($tmp = (isset($context["maintenance_mode"]) || array_key_exists("maintenance_mode", $context) ? $context["maintenance_mode"] : (function () { throw new RuntimeError('Variable "maintenance_mode" does not exist.', 79, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Activé") : ("Désactivé"));
        yield "
                                </span>
                            </div>
        ...
        // line 84
        yield (((($tmp = (isset($context["maintenance_mode"]) || array_key_exists("maintenance_mode", $context) ? $context["maintenance_mode"] : (function () { throw new RuntimeError('Variable "maintenance_mode" does not exist.', 84, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("danger") : ("success"));
        yield "\">
                                    ";
        // line 85
        yield (((($tmp = (isset($context["maintenance_mode"]) || array_key_exists("maintenance_mode", $context) ? $context["maintenance_mode"] : (function () { throw new RuntimeError('Variable "maintenance_mode" does not exist.', 85, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Désactiver") : ("Activer"));
        yield " le mode maintenance
                        ...
                        ";
        // line 89
        if ((($tmp = (isset($context["maintenance_mode"]) || array_key_exists("maintenance_mode", $context) ? $context["maintenance_mode"] : (function () { throw new RuntimeError('Variable "maintenance_mode" does not exist.', 89, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 90
        ...
        // line 107
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["admin_email"]) || array_key_exists("admin_email", $context) ? $context["admin_email"] : (function () { throw new RuntimeError('Variable "admin_email" does not exist.', 107, $this->source); })()), "html", null, true);
        yield "\">
        ...
        // line 148
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["privacy_policy"]) || array_key_exists("privacy_policy", $context) ? $context["privacy_policy"] : (function () { throw new RuntimeError('Variable "privacy_policy" does not exist.', 148, $this->source); })()), "html", null, true);
        yield "</textarea>
        ...
        // line 164
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["legal_notice"]) || array_key_exists("legal_notice", $context) ? $context["legal_notice"] : (function () { throw new RuntimeError('Variable "legal_notice" does not exist.', 164, $this->source); })()), "html", null, true);
        yield "</textarea>
                                    <small class=\"text-muted\">Vous pouvez utiliser des balises HTML pour la mise en forme.</small>
                                </div>
                                <div class=\"mb-3\">
        ...
        // line 180
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["terms_of_service"]) || array_key_exists("terms_of_service", $context) ? $context["terms_of_service"] : (function () { throw new RuntimeError('Variable "terms_of_service" does not exist.', 180, $this->source); })()), "html", null, true);
        yield "</textarea>
                                    <small class=\"text-muted\">Vous pouvez utiliser des balises HTML pour la mise en forme.</small>
                                </div>
                                <div class=\"mb-3\">
...
";
    ...
    {
        return array (  368 => 180,  362 => 177,  346 => 164,  340 => 161,  324 => 148,  318 => 145,  277 => 107,  271 => 104,  260 => 95,  253 => 90,  251 => 89,  244 => 85,  240 => 84,  236 => 83,  232 => 82,  226 => 79,  222 => 78,  203 => 61,  193 => 57,  190 => 56,  186 => 55,  183 => 54,  173 => 50,  170 => 49,  166 => 48,  159 => 44,  154 => 41,  144 => 40,  118 => 21,  108 => 20,  87 => 6,  77 => 5,  60 => 3,  43 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{% extends 'admin/layout_custom.html.twig' %}
            ...
            <div class=\"card mb-4\">
                ...
                <div class=\"card-body\">
                    <div class=\"mb-4\">
                        ...
                        <div class=\"d-flex align-items-center\">
                            <div class=\"me-3\">
                                <span class=\"badge bg-{{ maintenance_mode ? 'success' : 'secondary' }} p-2\">
                                    {{ maintenance_mode ? 'Activé' : 'Désactivé' }}
                                </span>
                            </div>
                            <form method=\"post\" action=\"{{ path('admin_config_maintenance_toggle') }}\">
                                <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('maintenance_toggle') }}\">
                                <button type=\"submit\" class=\"btn btn-{{ maintenance_mode ? 'danger' : 'success' }}\">
                                    {{ maintenance_mode ? 'Désactiver' : 'Activer' }} le mode maintenance
                                </button>
                            </form>
                        </div>
                        {% if maintenance_mode %}
                    ...
                    <div class=\"mb-4\">
                        ...
                        <form method=\"post\">
                            <input type=\"hidden\" name=\"admin_email_form\" value=\"1\">
                            <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('admin_email_update') }}\">
                            <div class=\"mb-3\">
                                <label for=\"admin_email\" class=\"form-label\">Adresse email de l'administrateur</label>
                ...
                <div class=\"card-body\">
                    ...
                    <div class=\"tab-content pt-3\" id=\"legalTabsContent\">
                        ...
                        <div class=\"tab-pane fade show active\" id=\"privacy\" role=\"tabpanel\" aria-labelledby=\"privacy-tab\">
                            <form method=\"post\">
                                <input type=\"hidden\" name=\"privacy_policy_form\" value=\"1\">
                                <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('privacy_policy_update') }}\">
                                <div class=\"mb-3\">
                                    <label for=\"privacy_policy\" class=\"form-label\">Texte de la politique de confidentialité</label>
                                    <textarea class=\"form-control\" id=\"privacy_policy\" name=\"privacy_policy\" rows=\"15\">{{ privacy_policy }}</textarea>
                                    <small class=\"text-muted\">Vous pouvez utiliser des balises HTML pour la mise en forme.</small>
                                </div>
                                <div class=\"mb-3\">
                                    <button type=\"submit\" class=\"btn btn-primary\">Enregistrer</button>
                        ...
                        <div class=\"tab-pane fade\" id=\"legal\" role=\"tabpanel\" aria-labelledby=\"legal-tab\">
                            <form method=\"post\">
                                <input type=\"hidden\" name=\"legal_notice_form\" value=\"1\">
                                <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('legal_notice_update') }}\">
                                <div class=\"mb-3\">
                                    <label for=\"legal_notice\" class=\"form-label\">Texte des mentions légales</label>
                                    <textarea class=\"form-control\" id=\"legal_notice\" name=\"legal_notice\" rows=\"15\">{{ legal_notice }}</textarea>
                                    <small class=\"text-muted\">Vous pouvez utiliser des balises HTML pour la mise en forme.</small>
                                </div>
                                <div class=\"mb-3\">
                                    <button type=\"submit\" class=\"btn btn-primary\">Enregistrer</button>
                        ...
                        <div class=\"tab-pane fade\" id=\"terms\" role=\"tabpanel\" aria-labelledby=\"terms-tab\">
                            <form method=\"post\">
                                <input type=\"hidden\" name=\"terms_of_service_form\" value=\"1\">
                                <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('terms_of_service_update') }}\">
                                <div class=\"mb-3\">
                                    <label for=\"terms_of_service\" class=\"form-label\">Texte des conditions générales de vente</label>
                                    <textarea class=\"form-control\" id=\"terms_of_service\" name=\"terms_of_service\" rows=\"15\">{{ terms_of_service }}</textarea>
                                    <small class=\"text-muted\">Vous pouvez utiliser des balises HTML pour la mise en forme.</small>
                                </div>
                                <div class=\"mb-3\">
                                    <button type=\"submit\" class=\"btn btn-primary\">Enregistrer</button>
...
{% endblock %}", "admin/config/index.html.twig", "/home/clients/0b7b1b2beec33c6f8b1ed00b9312f0c7/sites/SHOP-BJ/templates/admin/config/index.html.twig");
    }
}
