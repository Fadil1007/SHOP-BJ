...
class __TwigTemplate_ea209c3c9172f4a6d16df8f76cba9e48 extends Template
{
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 6
        yield "<div style=\"padding: 20px; background-color: #f8f9fa; border-radius: 8px; margin-bottom: 20px;\">
    <h2 style=\"color: #FF6B6B; margin-top: 0;\">Bienvenue ";
        // line 7
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "firstName", [], "any", false, false, false, 7), "html", null, true);
        yield " !</h2>
...
";
    ...
    Cet email a été envoyé à ";
        // line 40
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "email", [], "any", false, false, false, 40), "html", null, true);
...
";
    ...
    {
        return array (  119 => 40,  116 => 39,  109 => 38,  74 => 7,  71 => 6,  64 => 5,  53 => 3,  42 => 1,);
    }
