 ...
 */
class CartItem extends \App\Entity\CartItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\CartItem' . "\0" . 'id', '' . "\0" . 'App\\Entity\\CartItem' . "\0" . 'user', '' . "\0" . 'App\\Entity\\CartItem' . "\0" . 'product', '' . "\0" . 'App\\Entity\\CartItem' . "\0" . 'quantity', '' . "\0" . 'App\\Entity\\CartItem' . "\0" . 'size', '' . "\0" . 'App\\Entity\\CartItem' . "\0" . 'color', '' . "\0" . 'App\\Entity\\CartItem' . "\0" . 'createdAt'];
        }
