...
class OrderItem extends \App\Entity\OrderItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\OrderItem' . "\0" . 'id', '' . "\0" . 'App\\Entity\\OrderItem' . "\0" . 'order', '' . "\0" . 'App\\Entity\\OrderItem' . "\0" . 'product', '' . "\0" . 'App\\Entity\\OrderItem' . "\0" . 'quantity', '' . "\0" . 'App\\Entity\\OrderItem' . "\0" . 'price', '' . "\0" . 'App\\Entity\\OrderItem' . "\0" . 'size', '' . "\0" . 'App\\Entity\\OrderItem' . "\0" . 'color'];
        }
     ...
     * {@inheritDoc}
     */
    public function setOrder(?\App\Entity\Order $order): static
    {
