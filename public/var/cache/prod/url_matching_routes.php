...
return [
    ...
    [ // $dynamicRoutes
        ...
        693 => [[['_route' => 'cart_add', '_controller' => 'App\\Controller\\CartController::add'], ['id'], ['POST' => 0], null, false, true, null]],
        716 => [[['_route' => 'cart_update', '_controller' => 'App\\Controller\\CartController::update'], ['id'], ['POST' => 0], null, false, true, null]],
        739 => [[['_route' => 'cart_remove', '_controller' => 'App\\Controller\\CartController::remove'], ['id'], ['POST' => 0], null, false, true, null]],
        761 => [[['_route' => 'category_show', '_controller' => 'App\\Controller\\CategoryController::show'], ['id'], null, null, false, true, null]],
        802 => [[['_route' => 'checkout_confirmation', '_controller' => 'App\\Controller\\CheckoutController::confirmation'], ['id'], null, null, false, true, null]],
        833 => [[['_route' => 'checkout_fedapay_verify', '_controller' => 'App\\Controller\\CheckoutController::verifyFedaPayPayment'], ['id'], ['POST' => 0], null, false, true, null]],
        866 => [[['_route' => 'checkout_payment_success', '_controller' => 'App\\Controller\\CheckoutController::paymentSuccess'], ['id'], null, null, false, true, null]],
        915 => [[['_route' => 'product_category_by_slug', '_controller' => 'App\\Controller\\ProductController::categoryBySlug'], ['slug'], null, null, false, true, null]],
        928 => [[['_route' => 'product_show', '_controller' => 'App\\Controller\\ProductController::show'], ['id'], null, null, false, true, null]],
        959 => [[['_route' => 'app_review_new', '_controller' => 'App\\Controller\\ReviewController::new'], ['productId'], null, null, false, false, null]],
        986 => [[['_route' => 'review_add', '_controller' => 'App\\Controller\\ReviewController::add'], ['id'], ['POST' => 0], null, false, false, null]],
        1015 => [[['_route' => 'app_profile_order_show', '_controller' => 'App\\Controller\\ProfileController::showOrder'], ['id'], null, null, false, true, null]],
        1056 => [[['_route' => 'app_reset_password', '_controller' => 'App\\Controller\\ResetPasswordController::reset'], ['token'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        1093 => [[['_route' => 'wishlist_add', '_controller' => 'App\\Controller\\WishlistController::add'], ['id'], ['POST' => 0], null, false, true, null]],
        1120 => [[['_route' => 'wishlist_remove', '_controller' => 'App\\Controller\\WishlistController::remove'], ['id'], ['POST' => 0], null, false, true, null]],
        1145 => [[['_route' => 'wishlist_check', '_controller' => 'App\\Controller\\WishlistController::check'], ['id'], ['GET' => 0], null, false, true, null]],
        1171 => [
